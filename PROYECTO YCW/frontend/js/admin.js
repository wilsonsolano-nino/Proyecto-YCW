...
async function cargarEstadisticas() {
    try {
        ...
        // Cargar locales
        const localesResponse = await fetch('https://proyecto-ycw-production.up.railway.app/api/locales');
        const locales = await localesResponse.json();
        
        // Cargar arrendatarios
        const arrendatariosResponse = await fetch('https://proyecto-ycw-production.up.railway.app/api/arrendatarios');
        const arrendatarios = await arrendatariosResponse.json();
        
        // Cargar contratos
        const contratosResponse = await fetch('https://proyecto-ycw-production.up.railway.app/api/contratos');
        const contratos = await contratosResponse.json();
        
        // Cargar pagos
        const pagosResponse = await fetch('https://proyecto-ycw-production.up.railway.app/api/pagos');
...
async function cargarLocales() {
    try {
        ...
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/locales');
        if (!response.ok) {
...
async function editarLocal(id) {
    try {
        ...
        const response = await fetch(`https://proyecto-ycw-production.up.railway.app/api/locales/${id}`);
...
async function cargarArrendatarios() {
    try {
        ...
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/arrendatarios');
        if (!response.ok) {
            throw new Error(`Error HTTP: ${response.status}`);
        }
...
async function editarArrendatario(id) {
    try {
        ...
        const response = await fetch(`https://proyecto-ycw-production.up.railway.app/api/arrendatarios/${id}`);
...
async function cargarTodosLosPagos() {
    try {
        ...
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/pagos');
...
async function cargarDatosReportePagos() {
    try {
        ...
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/pagos/reporte-pagos-mes');
...
async function cargarDatosMora() {
    try {
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/pagos/reporte-mora');
        const data = await response.json();
...
async function cargarServicios() {
    ...
    try {
        ...
        const testResponse = await fetch('https://proyecto-ycw-production.up.railway.app/api/servicios-por-local');
...
async function cargarDatosParaAgregarServicio() {
    try {
        ...
        const responseLocales = await fetch('https://proyecto-ycw-production.up.railway.app/api/locales');
        ...
        const [serviciosResponse, serviciosAsignadosResponse] = await Promise.all([
            fetch('https://proyecto-ycw-production.up.railway.app/api/servicios-disponibles'),
            fetch('https://proyecto-ycw-production.up.railway.app/api/servicios-por-local')
        ]);
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('formAgregarServicio').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/servicios-por-local', {
                method: 'POST',
                headers: {
...
async function cargarDatosParaAgregarServicio() {
    try {
        ...
        const responseServicios = await fetch('https://proyecto-ycw-production.up.railway.app/api/servicios-disponibles');
...
async function cargarDatosParaServicio() {
    try {
        ...
        // Cargar servicios disponibles
        const responseServicios = await fetch('https://proyecto-ycw-production.up.railway.app/api/servicios');
        const servicios = await responseServicios.json();
...
document.addEventListener('submit', async (e) => {
    if (e.target.id === 'formAgregarServicio') {
        ...
        try {
            const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/agregar-servicio-local', {
                method: 'POST',
                headers: { 
                    'Content-Type': 'application/json'
                },
...
async function reorganizarLocales() {
    try {
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/locales/reorganizar', {
            method: 'POST'
        });
        const data = await response.json();
        if (data.success) {
...
async function verContrato(idContrato) {
    try {
        const response = await fetch(`https://proyecto-ycw-production.up.railway.app/api/contratos/${idContrato}`);
...
async function cargarDatosContrato() {
    try {
        ...
        // Cargar arrendatarios
        const responseArrendatarios = await fetch('https://proyecto-ycw-production.up.railway.app/api/arrendatarios');
...
document.getElementById('formContratoNuevo').addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/contratos', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function editarContrato(id) {
    try {
        ...
        const response = await fetch(`https://proyecto-ycw-production.up.railway.app/api/contratos/${id}`);
        const contrato = await response.json();
...
async function cargarMantenimiento() {
    ...
    try {
        ...
        const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/mantenimiento/solicitudes');
...
function inicializarFormularioEstado() {
    ...
    if (formEstado) {
        formEstado.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('https://proyecto-ycw-production.up.railway.app/api/mantenimiento/actualizar-estado', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
                        id: parseInt(id), 
